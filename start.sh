...
export CLASSPATH="$HAZELCAST_HOME/lib/hazelcast-all-3.7.5.jar"
export CLASSPATH="$CLASSPATH:/home/ilya/share/sandbox.jar:"`/home/ilya/hbase-1.2.4/bin/hbase classpath`":/home/ilya/share/amqp-client-4.0.2.jar:/home/ilya/share/hadoop-common-2.5.1.jar"
...
if [ -z "${PID}" ]; then
    ...
    echo "Another hazelcast instance is already started in this folder. To start a new instance, please unzip 3.7.5.zip/tar.gz in a new folder."
    exit 0
fi
